...
class InsDetectListRecordController: UIViewController, UITableViewDelegate, UITableViewDataSource, EPSignatureDelegate {
	...
	func initLayaout() {
		...
		lblTitle.text = "驗屋紀錄_" + InsTargetData.sharedInstance().building + "_" + InsTargetData.sharedInstance().floor + "_" + InsTargetData.sharedInstance().room + "_" + InsTargetData.sharedInstance().inspNo;
