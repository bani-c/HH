...
class AddMistakeEditPController: UIViewController, CameraControllerDelegate, UIPickerViewDelegate, UIPickerViewDataSource, UITextFieldDelegate {
    ...
    @IBOutlet weak var lcVwAmount: NSLayoutConstraint!
